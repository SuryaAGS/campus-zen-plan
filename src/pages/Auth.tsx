...
export default function Auth() {
  ...
  return (
    <div className="app-gradient-bg flex items-center justify-center px-4">
      <motion.div
      ...
      >
        <div className="mb-6 flex items-center justify-center gap-2">
          ...
          <h1 className="font-display text-2xl font-bold text-foreground">Tasks To Do</h1>
        </div>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="glass rounded-full px-3 py-0.5 text-muted-foreground">Or continue with</span>
          </div>
        </div>
        ...
        <button
          ...
          className="glass flex w-full items-center justify-center gap-2 rounded-xl px-4 py-2.5 text-sm font-medium text-foreground transition-all hover:bg-primary/10"
        >
